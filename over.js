...
const solohitech = async () => {
  ...
  await page.goto('https://smarttrader.deriv.com/en/trading?currency=USD&market=synthetics&underlying=R_100&formname=overunder&duration_amount=1&duration_units=t&amount=10&amount_type=stake&expiry_type=duration&prediction=0');
...
//////////////////////////////////////////////////////
        ...
        await page.waitForSelector('#close_confirmation_container', { visible: true, timeout: 300000 });
